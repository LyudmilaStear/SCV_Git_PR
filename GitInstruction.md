...
#### *13.5 Запрос на изменения проекта первоисточнику*
На странице нашего проекта появляется кнопка *pull request*.  
Мы ее нажимаем и запоняем по необходиимости комментарии и отправляем запрос.
Все! Ждем примет или не примет первосточник, предложенные нами изменения.